...
const Cards = (props) => {
  ...
  return (
    <div className="card">
      ...
      <Model ariaHideApp={false} portalClassName="pop-up-form" isOpen={open} onRequestClose={()=>setOpen(false)} >Modal Body
              ...
              <div className="e1">
                <label>Graduation Date</label>
                  <input
                    ...
                    value={data.gradDate || ''}
                    onChange={(e) => setData({ ...data, gradDate: e.target.value })}>
                  </input>
              </div>
            </div>
