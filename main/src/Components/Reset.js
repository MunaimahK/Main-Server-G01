    ...
    <div>
      ...
      <div class="container-n w-100">
        <div class="row gy-4 align-items-center">
            ...
            <div class="d-flex justify-content-center text-bg-primary">
              <div class="col-12 col-xl-9">
                <img
                  ...
                  loading="lazy"
                  src="main/src/Components/assets/influx-logo.png"
                  width="245"
                  height="80"
                  alt="BootstrapBrain Logo"
                />
                <hr class="border-primary-subtle mb-4" />
                <h2 class="h1 mb-4">Influx Admin</h2>
                <p class="lead mb-5">
                  You're a powerful member of the Influx community!
                </p>
                <div class="text-endx">
                  <svg
          ...
          <div class="col-12 col-md-6 col-xl-5 w-80">
